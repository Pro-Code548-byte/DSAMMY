...
function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    const whatsappMessage = `Hello DSAMMY! I'm interested in joining.%0A%0A*Name:* ${formData.name}%0A*Email:* ${formData.email}%0A*Phone:* ${formData.phone}%0A*Division:* ${formData.division}%0A*Message:* ${formData.message}`
              ...
              <div className="contact-details">
                ...
                <div className="contact-detail-item">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/2349013989363" target="_blank" rel="noopener noreferrer">09013989363</a>
                  </div>
                </div>
